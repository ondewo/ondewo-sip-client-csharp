...
* Initial release of the ONDEWO SIP C# client. The package `Ondewo.SIP.Client` ships the
  gRPC message and client stubs generated from the [ONDEWO SIP API](https://github.com/ondewo/ondewo-sip-api)
