...
namespace Ondewo.Sip.Client.Tests
{
    ...
    public class OndewoAuthTests
    {
        ...
        public async Task CreateBearerInterceptorAppendsTheTokenToCallMetadata()
        {
            ...
            await interceptor(new AuthInterceptorContext("https://sip.ondewo.com", "SipGetSipStatus"), metadata);
        ...
        {
            AsyncAuthInterceptor interceptor = OndewoAuth.CreateBearerInterceptor(Token);
            var context = new AuthInterceptorContext("https://sip.ondewo.com", "SipGetSipStatus");
